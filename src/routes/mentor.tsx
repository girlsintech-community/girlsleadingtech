...
export const Route = createFileRoute("/mentor")({
  head: () => ({
    meta: [
      { title: "Mentor & Speaker — Girls Leading Tech" },
      { name: "description", content: "Share your experience with the Girls Leading Tech community." },
    ],
  }),
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-300 text-sm leading-relaxed animate-reveal-field" style={{ fontFamily: "'Satoshi', sans-serif", animationDelay: "200ms" }}>
                  Share your experience, mentor ambitious students, and contribute to the growth of women in technology.
                </p>
              </div>
            </div>
          ...
          {submitted ? (
            <div className="flex flex-col items-center justify-center text-center py-10 animate-fade-up">
              ...
              <p className="mt-3 text-gray-655 max-w-md mx-auto text-sm leading-relaxed font-semibold">
                Thank you, <strong>{formData.name}</strong>. We appreciate you volunteering your expertise for GLT. Our team will review your LinkedIn profile and reach out via <strong>{formData.email}</strong> shortly.
              </p>
              <button
                onClick={() => {
                  setSubmitted(false);
                  setFormData({ name: "", email: "", linkedin: "", currentRole: "", company: "", experience: "", availability: "" });
                  setSelectedTopics([]);
                }}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="text-left mb-3 animate-reveal-field" style={{ animationDelay: "0ms" }}>
                <h3 className="text-2xl font-extrabold text-gray-900" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                  Share Your Experience
                </h3>
                <p className="text-gray-500 text-sm mt-1">
                  Fill out the form below to apply as a mentor or speaker.
                </p>
              </div>
              ...
              {/* Row 2: Role, Company, Availability */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {/* Current Role */}
              ...
              <div className="flex flex-col items-start gap-2 animate-reveal-field" style={{ animationDelay: "560ms" }}>
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Topics You Can Help With</label>
                  ...
                  {topicsList.map((topic) => {
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-2 rounded-xl border-2 text-xs font-bold transition-all duration-200 cursor-pointer ${
                          isSelected
                            ? "bg-[#24101F] border-black text-white shadow-[2px_2px_0px_rgba(0,0,0,1)]"
                            : "bg-white border-[#E6DDE3] text-gray-650 hover:border-[#24101F]"
                        }`}
                      >
                        {topic}
                      </button>
              ...
              {/* Experience textarea */}
              <div className="flex flex-col items-start gap-1.5 animate-reveal-field" style={{ animationDelay: "640ms" }}>
                <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Experience Details</label>
                <textarea
                  ...
                  placeholder="Share a short summary of your background, topic interest or mentorship goals."
                  required
                />
              </div>

              {/* Submit Button */}
              <div className="pt-1 flex justify-start animate-reveal-field" style={{ animationDelay: "720ms" }}>
                <button
                  type="submit"
