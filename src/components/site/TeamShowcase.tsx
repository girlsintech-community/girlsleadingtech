...
// Fixed viewport height for the scrollable grid (roughly 2 rows + breathing room)
const SCROLL_AREA_HEIGHT = "min(70vh, 720px)";
      ...
      <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-14">
        ...
        <div className="w-full lg:w-[65%] flex flex-col gap-6">
          ...
          <div className="relative">
            ...
            {/* Cards grid — vertically scrollable, framed in its own soft panel */}
            {statusFilteredTeam.length === 0 ? (
              ...
              <>
                ...
                <motion.div
                  ...
                  className="rounded-2xl border border-black/5 bg-zinc-50/50 p-5 md:p-6"
                >
                  <div
                    className="team-scroll-area overflow-y-auto pr-4"
                    style={{ maxHeight: SCROLL_AREA_HEIGHT }}
                  >
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-5 pb-2">
                ...
                {/* Fade hint — signal there's more to scroll, softened into the panel's own background */}
                {statusFilteredTeam.length > 6 && (
                  <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-zinc-50/90 via-zinc-50/40 to-transparent rounded-b-2xl" />
                )}
              </>
            )}
          </div>
